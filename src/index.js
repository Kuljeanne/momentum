...
if (!localStorage.getItem('photoSourse')) { localStorage.setItem('photoSourse', 'github') };
if (!localStorage.getItem('blocks')) { localStorage.setItem('blocks', 'time,date,greeting,quote,weather,audio,links') }
...
playList.forEach(elem => createPlayItem(elem));
